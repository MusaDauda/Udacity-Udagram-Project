...
```
### Building
- I am using a windows machine so I had to modify the package.json file to build and create the Archive.zip file.
...
``` url
http://musa-udacity-udagram-dev.us-east-1.elasticbeanstalk.com/
```